...
<?php
      ...
      $sql="Select * from admin"; //add a new sql query
      ...
      while($rows = mysqli_fetch_array($result))
      {
          ...
          echo "<td>".$rows['adminname']."</td>";
          echo "<td>".$rows['adminemail']."</td>";
          echo "<td>".$rows['adminpass']."</td>";
          //create 2 buttons (edit button and delete button in each column)
          echo "<td><a href='adminedit.php?admin_id=".$rows['admin_id']."'><button>Edit</button></a></td>";
          echo "<td><a href='admindelete.php?admin_id=".$rows['admin_id']."'><button>Delete</button></a></td>";
          echo "</tr>";
      }
?>
</table></br>
