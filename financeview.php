...
<?php
      ...
      $sql="Select * from finance"; //add a new sql query
      ...
      {
          echo "<tr>";
          echo "<td>".$rows['finance_id']."</td>";
          echo "<td>".$rows['financename']."</td>";
          echo "<td>".$rows['financeemail']."</td>";
          echo "<td>".$rows['financepass']."</td>";
          //create 2 buttons (edit button and delete button in each column)
          echo "<td><a href='financeedit.php?finance_id=".$rows['finance_id']."'><button>Edit</button></a></td>";
          echo "</tr>";
      }
?>
</table></br>
