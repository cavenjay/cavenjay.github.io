...
<form method="post" action="adminupdate.php">
  <table style="text-align:center">
    <tr><th width="300px">ID</th>
      <td><input type="text" name="uid" value="<?php echo $rows['admin_id']  ?>" readonly/></td>
    </tr>
<tr><th>Name:</th><td width="300px">
  <input type="text" name="name1" value="<?php echo $rows['adminname']?>"required="required"/>
</td>
</tr>
<tr><th>Email Address</th><td>
  <input name="email1" required="required" value="<?php echo $rows['adminemail']?>"/>
</td>
</tr>
...
<center>
  ...
  <input type="submit"value="Back to Previous Page" class="btn" formaction="adminview.php"/>
</center>
</td>
</tr>
</table>
