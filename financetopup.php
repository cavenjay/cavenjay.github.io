...
<body style="background-color:lightblue">
  ...
  <div id="wordabovenav">
    <h2 style="font-size: 80px;">TOP UP</h2>
  </div>
  <div class="topnav">
...
<!--------------------------------------- seperate parts------------------------------------------------->
<?php include('financetopupserver.php') ?>
...
<head>
  ...
  ?>
  <form method="post" action="financetopup.php">
    ...
    <div class="input-group">
  	...
  	<div class="input-group">
  	  ...
  	  <input type="number" name="topup" value="">
  	</div>
  	<div class="input-group">
  	  <button type="submit" class="btn" name="reg_trans">Enter</button>
      <a href="financetopup.php" target="" class="btn" name="backbut">Cancel</a>
    </div>
