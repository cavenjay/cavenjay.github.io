...
<?php
    ...
    $uid = $_GET['finance_id'];
    //write the sql query
    $sql = "Select * from finance where finance_id = $uid";
...
<form method="post" action="financeupdate.php">
  <table style="text-align:center">
    <tr><th width="300px">ID</th>
      <td><input type="text" name="uid" value="<?php echo $rows['finance_id']  ?>" readonly/></td>
    </tr>
<tr><th>Name:</th><td width="300px">
  <input type="text" name="name1" value="<?php echo $rows['financename']?>"required="required"/>
</td>
</tr>
<tr><th>Email Address</th><td>
  <input name="email1" required="required" value="<?php echo $rows['financeemail']?>"/>
</td>
</tr>
...
<center>
  ...
  <input type="submit"value="Back to Previous Page" class="btn"  formaction="financeview.php"/>
</center>
</td>
</tr>
</table>
...
<?php
  ...
  window.location.href='financeview.php'</script>");
}
?>
